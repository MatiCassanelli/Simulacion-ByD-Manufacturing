========================================================================
    APLICACIÓN DE CONSOLA: Simulacion ByD Manufacturing Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación Simulacion ByD Manufacturing.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación Simulacion ByD Manufacturing.


Simulacion ByD Manufacturing.vcxproj
...
Simulacion ByD Manufacturing.vcxproj.filters
...
Simulacion ByD Manufacturing.cpp
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado Simulacion ByD Manufacturing.pch y un archivo de tipos precompilados llamado StdAfx.obj.
